...
from ...dept_tools.common_tools import *
...
class CommonWidget( QtWidgets.QWidget ):
    ...
    MOD_PATH = os.path.normpath(os.path.join(os.path.dirname(__file__), "..", "..", "dept_tools/common_tools" ))
    
    OBJECT_NAME = 'Common_Tool_Widget'
    WIN_TITLE = "Common Rigging Tools"
    ...
    def __init__(self, parent=None):
        ...
        file_basename = "common_tool_list"
